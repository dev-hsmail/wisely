      			...
      			<div class="box-body">
      				<form id="productForm" action="productInsert" method="post" enctype="multipart/form-data">
      						...
      						<div class="col-sm-3">
      							<select name="ctgr_cd_prt" id="firstCategory" class="form-control">
      								...
      								<c:forEach items="${cateList}" var="categoryVO">
      									<option value="${categoryVO.ctgr_cd }">${categoryVO.ctgr_nm }</option>
      								</c:forEach>
      							</select>
      						</div>
      						<div class="col-sm-3">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="prdc_nm" name="prdc_nm">
							</div>
							<label for="prdc_prc" class="col-sm-2 col-form-label">상품가격</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" id="prdc_prc" name="prdc_prc">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="prdc_dsct" name="prdc_dsct">
							</div>
							<label for="prdc_com" class="col-sm-2 col-form-label">제조사</label>
							<div class="col-sm-4">
								<input type="text" class="form-control" id="prdc_com" name="prdc_com">
							</div>
						</div>
						
						<div class="form-group row">
							<label for="prdc_img" class="col-sm-2 col-form-label">상품이미지</label>
							<div class="col-sm-4">	<!-- name="prdc_img" 존재안하면 스프링에서 null이 된다. -->
								<input type="file" class="form-control" id="uploadFile" name="uploadFile">
							</div>
              				<label for="prdc_img" class="col-sm-2 col-form-label">미리보기 이미지</label>
							<div class="col-sm-4">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" id="prdc_dtl" name="prdc_dtl" rows="3"></textarea>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="prdc_amt" name="prdc_amt">
							</div>
